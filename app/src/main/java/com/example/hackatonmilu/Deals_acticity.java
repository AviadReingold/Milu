...
public class Deals_acticity extends AppCompatActivity implements View.OnClickListener {

    public android.widget.Button btnDeal1,btnDeal2,btnDeal3,btnDeal4,btnDeal5,btnDeal6,btnDeal7,btnDeal8,btnDeal9,btnDeal10,btnDeal11,btnDeal12;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_deals_acticity);
